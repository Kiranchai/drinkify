export default function verificationEmailTemplate(token) {
  ...
  body {font-family: 'Muli', sans-serif;}
    ...
    <![endif]-->
    ...
    </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:30px 20px 30px 20px; background:linear-gradient(0deg,#510a32 0%,rgba(45,20,44,1) 50%)" data-distribution="1">
      <tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:30px 30px 18px 30px; text-align:inherit; background-color:#641542;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit;"><span style="font-size:28px; color: white">Otrzymaliśmy prośbę o zresetowanie twojego hasła w <strong style="color:#bb3bd9">Drinkify</strong></span></div><div></div></div></td>
        </tr>
      </tbody>
    </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
      <tbody>
        <tr>
          <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#641542;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
          <div><div style="font-family: inherit;"><span style="font-size: 15px; color: white; font-weight:700">Ochrona twoich danych jest dla nas ważna.</span><br><span style="font-size: 15px; color: white">Naciśnij przycisk poniżej, aby rozpocząć proces zmiany hasła.</span>
          
          <a href="${process.env.NEXT_PUBLIC_FRONTEND_ENDPOINT}/resetPassword?token=${token}" style="background-color:#bb3bd9; border:1px solid #bb3bd9; border-color:#bb3bd9; border-radius:0px; border-width:1px; color:#fff; display:inline-block; font-size:14px; font-weight:bold; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit; margin-top:25px;" target="_blank">Zmień hasło</a>
          </div>
          <div style="margin-top:40px;">
          <span style="color:white; opacity:0.8;">Jeśli prośba zmiany hasła nie była wysłana przez Ciebie, zignoruj tą wiadomość lub skontaktuj się z nami na <strong>contact@drinkify.pl</strong></span>
          </div>
          
  <div style="font-family: inherit; text-align: center"><span style="color: #bb3bd9; font-size: 18px"></span></div><div></div></div></td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:0px 0px 20px 0px;" role="module-content" bgcolor="#641542">
          </td>
        </tr>
      </tbody>
    </table>
