  ...
  return `
    ...
    body {font-family: 'Muli', sans-serif;}
      ...
      <![endif]-->
        ...
        <tbody>
          <tr>
            <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
              <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="120" alt="" data-proportionally-constrained="true" data-responsive="false" src="http://cdn.mcauto-images-production.sendgrid.net/acbca28ba99b7c22/8e119b27-08f4-4635-ab76-3db73e3c10fa/120x120.png" height="120">
            </td>
          </tr>
        </tbody>
        ...
        <tbody>
          <tr>
            <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#641542;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: clamp(30px, 6vw, 43px); color: white">Dziękujemy za rejestrację!</span></div><div></div></div></td>
          </tr>
        </tbody>
      </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
        <tbody>
          <tr>
            <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#641542;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px; color: white">Zweryfikuj swój adres email, aby móc w pełni cieszyć się naszą aplikacją!</span></div>
    <div style="font-family: inherit; text-align: center"><span style="color: #bb3bd9; font-size: 18px"><strong>Dziękujemy!</strong></span></div><div></div></div></td>
          </tr>
        </tbody>
        ...
        <tbody>
          ...
          <tbody>
            <tr>
              <td align="center" bgcolor="#ffffff" class="outer-td" style="padding:0px 0px 0px 0px; background-color:#641542;">
                <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                  <tbody>
                    ...
                    <td align="center" bgcolor="#ffbe00" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                      <a href="${process.env.NEXT_PUBLIC_FRONTEND_ENDPOINT}/verification/email?token=${token}" style="background-color:#bb3bd9; border:1px solid #bb3bd9; border-color:#bb3bd9; border-radius:0px; border-width:1px; color:#fff; display:inline-block; font-size:14px; font-weight:bold; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">Zweryfikuj email</a>
                    </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <tbody>
          <tr>
            <td style="padding:0px 0px 50px 0px;" role="module-content" bgcolor="#641542">
            </td>
          </tr>
        </tbody>
