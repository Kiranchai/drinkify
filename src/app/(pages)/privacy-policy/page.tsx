...
export const metadata: Metadata = {
  title: "Polityka prywatności | Drinkify",
  alternates: {
    canonical: "https://drinkify.pl/privacy-policy",
  },
};
    ...
    <>
      <section className={styles.privacy_section}>
        <div className={styles.inner_container}>
          <h1 className={styles.privacy_header}>Polityka Prywatności</h1>
          <p>
          ...
          <p>
            ...
            <Link href="https://drinkify.pl/regulamin">Regulaminu Serwisu</Link>
          ...
          <ul>
            <li>
              <p>
                <strong>Serwis</strong> - serwis internetowy "drinkify.pl"
                działający pod adresem https://drinkify.pl
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            ...
            zlokalizowanej poza obrębem granic Unii Europejskiej. Istnieje
            możliwość dostępu do danych wskutek prac serwisowych realizowanych
            przez personel usługodawcy. Dostęp do tych danych reguluje umowa
            zawarta pomiędzy Administratorem a Usługodawcą.
          </p>
          <p>
            <strong>Przetwarzanie danych w przypadku płatności on-line</strong>
          </p>
          <p>
            W przypadku realizacji płatności on-line, wszelkie dane dotyczące
            płatności przekazywane są bezpośrednio przez Użytkownika podmiotowi
            realizującemu płatność -{" "}
            <Link rel="nofollow external" href="https://stripe.com/privacy">
              Stripe. Wybrane dane niezbędne do realizacji transakcji są
              następnie przekazywane przez ten podmiot Administratorowi.
              Przekazanie danych reguluje umowa zawarta pomiędzy Administratorem
              a Usługodawcą.
            </Link>
          </p>
          ...
          <ul>
            <li>
              Dane osobowe są przekazywane poza Unię Europejską.Przekazanie
              danych poza UE jest spowodowane korzystaniem z usług podmiotów
              zlokalizowanych poza granicami UE, lub w wyniku opublikowania na
              skutek indywidualnego działania Użytkownika (np. wprowadzenie
              komentarza lub wpisu), co sprawi, że dane będą dostępne dla każdej
              osoby odwiedzającej serwis.W przypadku przekazania lub powierzenia
              przetwarzania danych osobowych poza granicami UE, dane te są
              przetwarzana na podstawie umowy zawartej pomiędzy Administratorem
              a Usługodawcą.
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>
                <strong>Prawo dostępu do danych osobowych</strong> Użytkownikom
                przysługuje prawo uzyskania dostępu do swoich danych osobowych,
            ...
            <li>
              <p>
                <strong>Prawo wniesienia skargi</strong> Użytkownikom
